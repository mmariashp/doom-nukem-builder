...
unsigned short			manage_btn(t_media *media, t_prog *prog, t_grid *grid, t_vec mouse);
...
void					move_player(t_prog *prog, t_vec mouse, t_grid *grid, t_world *world);
void					move_vector(t_prog *prog, t_vec mouse, t_grid *grid, t_world *world);
...
void					render_grid(t_world world, t_grid *grid, t_prog *prog, t_vec mouse);
...
void					upd_sec(t_sec *sec, t_wall *walls, t_vec *vecs, int n_s);
...
void					rend_box(t_rec box, SDL_Texture *t, SDL_Renderer *rend);
...
void					render_edit_menu(t_sdl *sdl, t_media *media, t_prog *prog, t_world *w);
...
void					render_values(t_value *values, t_sdl *sdl, t_prog *prog, t_media *media);
...
void					move_item(t_prog *prog, t_vec mouse, t_grid *grid, t_sec *sector);
void					add_item(int default_id, t_vec mouse, t_grid *grid, t_sec *sector);
...
void					grid_re(t_grid *grid, t_media *media, int state, int sector);
...
unsigned short			add_vec(t_vec **vecs, short n_v, t_grid *grid, short i);
...
void 					drawing(t_world *world, t_prog *prog, t_grid *grid, t_vec mouse);
...
void					normal_st(t_prog *prog, t_vec mouse, t_grid *grid, t_world *world);
void					wall_search_st(t_prog *prog, t_vec node, t_grid *grid, t_world *world);
void					sec_search_st(t_prog *prog, t_vec mouse, t_grid *grid, t_world *world);
void					sec_edit_st(t_prog *prog, t_vec mouse, t_grid *grid, t_media *media);

int 					get_sec_items(t_sec *sec, char *l);
char					*get_name(int i);
unsigned short			edit_texture(int fl_ceil, int n_t, t_texture *txtr, t_world *world);
t_vec					get_arrow_input(SDL_Keycode key, t_vec old);
void					edit_item_name(int n_itf, t_it_f *it_f, t_world *world);
void					render_cursor(SDL_Renderer *rend, t_vec mouse, SDL_Texture **t, int txtr_id);
...
void					draw_itms(SDL_Renderer *rend, t_media *media, t_grid *grid, SDL_Texture **t);

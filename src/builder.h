...
void					render_btn_big(t_btn *button, t_sdl *sdl, SDL_Texture \
**t);
...
unsigned short			btn_light(t_vec mouse, t_btn *btn, int n_btn, t_prog \
*prog);
...
void					draw_circle_fill(t_vec c, int radius, int color, \
SDL_Renderer *rend);
void					get_rgb(unsigned char *r, unsigned char *g, unsigned \
char *b, int color);
void					draw_line(t_line l, int color, SDL_Renderer *rend);
void					draw_line_grid(t_line l, char c, signed char \
nod[GRID_SIZE][GRID_SIZE]);
...
t_world *world);
void					wall_search_st(t_prog *prog, t_vec node, t_grid *grid,\
t_world *world);
void					sec_search_st(t_prog *prog, t_vec mouse, t_grid *grid,\
t_world *world);
...
void					render_item_info(t_media *med, t_sdl *sdl, t_mode *mode\
, SDL_Texture **t);
void					place_player_icons(t_world world, t_grid *grid, t_sdl\
*sdl);
...
unsigned short			get_n(char *line, unsigned short min, unsigned short \
max);
